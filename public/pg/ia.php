...
<div id="container">
    ...
    <main id="contenido">
      ...
      <ul class="punteo_01">
        ...
        <li><a href="https://www.stablediffusionai.ai/es" target="_blank">Stable Difussion</a>: Creador de imágenes.</li>
        <li><a href="https://sketch.metademolab.com/" target="_blank">Animated drawing</a>: Dale movimiento a tus dibujos.</li>
        <li><a href="https://www.imagine.art/" target="">Imagine</a>: Texto a imagen con un generador de arte IA.</li>
      </ul>
      <br>

      <h3>Herramientas para textos</h3>
      <ul class="punteo_01">
        <li><a href="https://www.copy.ai/" target="_blank">Copy</a>: Automatiza flujos de trabajo.</li>
        <li><a href="https://quillbot.com/" target="_blank">Quillbot</a>: Herramienta para parafrasear.</li>
        <li><a href="https://writesonic.com/" target="_blank">Writesonic</a>: Plataforma para la creación de contenido y SEO.</li>
        <li><a href="https://speechify.com/es/?landing_url=https%3A%2F%2Fspeechify.com%2Fes%2F" target="_blank">Speechify</a>: Conversor de texto a voz.</li>
        <li><a href="https://ttsmaker.com/es" target="_blank">TTSMaker</a>: Texto a voz.</li>
        <li><a href="https://murf.ai/" target="_blank">Murf</a>: Generador de voces reales.</li>
      ...
      <ul class="punteo_01">
        ...
        <li><a href="https://beta.monic.ai/" target="_blank">Monic.ai</a>: Ayudante para estudios. Flashcards, generación de cuestionarios, quizzes...</li>
      ...
      <ul class="punteo_01">
        ...
        <li><a href="https://chartgpt.io/" target="_blank">ChartGPT</a>: Generador de gráficos, código, conversacional...</li>
