<?php $nombre_pagina = "actividades"; ?>
<?php include '../../include/layout/head.php';?>
    <link rel="stylesheet" href="../css/tablas.css">
</head>
<body>
<h1 class="outline">Salas TIC. Biblioteca Universidad de Antofagasta</h1>
...
<div id="container">
    ...
    <main id="contenido">
        <h2>Salas TIC</h2>
        <p class="p_normal">Con el objetivo de promover la utilización de las tecnologías en el desarrollo de la educación, investigación y la docencia, brindamos los servicios de préstamo de computadores para la realización de clases, talleres, capacitaciones, pruebas en plataformas. También contamos con el servicio de préstamo de audífonos, tablets y calculadoras científicas.</p>
        <h4 class="ygh4">Horario de atención: lunes a JUEVES 8:00 a 18:30 h; VIERNES: 8:00 a 17:30 h.</h4>
        <h2>Auditórium</h2>
